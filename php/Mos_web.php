		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li><a href="Mos_data.php">資料頁面</a></li>
					<li><a href="Mos_device_distributed.php">分佈圖</a></li>
				</ul>
	...
	<div class="container">
		<div id="container" style="min-width: 310px; height: 400px; margin: 0 auto">
		 <table class="table table-hover">
			 	...
			 	<td><?=$item['Maintenance_time']?></td><td><?=$item['location']?></td><td><?=$item['keeper']?></td><td><a href="" role="btn" class="btn btn-danger">測試</a></td><td><a href="Mos_data.php?data=<?=$item['device_number']?>" role="btn" class="btn btn-danger">資料</a></td></tr>
			 	<?php endforeach; ?>
		</table>	
	</div>
</body>
